...
<head>
    ...
    <style>
      .modal-header {background:#D67B22;color:white;font-weight:800;}
      ...
      <div class="container-fluid" id="header">
          <div class="row">
              <div class="col-md-3 col-lg-3" id="category">
                  <div style="background:black;color:white;font-weight:800;border:none;padding:15px;"> The Book Shop </div>
                  <ul>
